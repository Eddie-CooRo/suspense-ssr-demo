export const boxOfficeMovies = [
  ...
  {id: 3, title: 'Black Panther', rating: '98%', gross: '$403.6M', fresh: true},
  {
    id: 4,
...
export const movieReviews = {
  1: [
    ...
    },
    {
      ...
      fresh: true,
      text:
        'While there is an acute authorial intelligence informing the transitions between scenes, the steady trot of clipped vignettes comes to seem monotonous and somewhat evasive, a way to move along before anything too hard and hurtful happens.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Lady Bird uses its eponymous protagonist in the construction of one of the most skeptical voices of modern cinematography.',
      author: {
    ...
    },
    {
      ...
      fresh: true,
      text:
        'There is no doubt that it has a certain charm. I guess a lot of its appeal lies in its accessibility, its slightly subversive attitude and its hipster aura.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        "Gerwig's film, which closes with a tribute to Sacramento, ends well and feels sincere.",
  ...
  2: [
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Payne’s film is full of invention, wit, great scenes and big—if not fully realised—intentions. Downsizing may be about a small world, but it is an audacious, out-sized peach of a picture.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Sometimes a change of perspective helps a person to better understand the world, and Downsizing makes it literal.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        '...an exquisite cast, probably one of the most intelligent comeidies of the year.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'The most ambitious and least convincing film of Nebraska’s talented filmmaker [Alexander Payne].',
  ...
  3: [
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Emotional, occasionally funny, and narratively unpredictable. (...) I doubt any other blockbuster will manage to surpass “Black Panther” this year.',
  ...
  4: [
    ...
    },
    {
      ...
      fresh: true,
      text:
        'The plot is straightforward, but the film’s tone and style supply an artful mix of sensations. The lighting is colorful and heady...The film’s rhythms gracefully accompany her endeavor, rising and falling with every setback or tiny, incremental victory.',
    ...
    },
    {
      ...
      fresh: false,
      text:
        'Compelling on a human level but dramatically monotonous. There aren’t exactly a lot of surprises here.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Vega establishes a milestone in the push for equality playing a transgender woman determined to properly grieve for her recently deceased lover.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Vega’s remarkable turn is something of a revelation, as if we are in on some kind of unique discovery.',
  ...
  6: [
    ...
    },
    {
      ...
      fresh: true,
      text:
        'There’s a quaintness about the film, from the animation style to the wholesome jokes, that is refreshing for this pop-culture-obsessed animation era.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'In the end, the great charm of the film is that it will seduce fans... and football opponents alike.',
    ...
    },
    {
      ...
      fresh: true,
      text:
        '...lovable characters and humor so innocent some may see it as demodé. [Full Review in Spanish]',
    ...
    },
    {
      ...
      fresh: true,
      text:
        'Might not be a particularly impressive film, and it darn sure isn’t a surprising film, but it is a wonderfully pleasant & pleasurable film.',
      author: {name: 'Tim Brayton', publication: 'Alternate Ending'},
    },
    {
      id: 10,
